    ...
    <section className="overflow-hidden relative pb-0 mb-0 w-full">
      <div className="w-full px-4 md:px-8 lg:px-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <DivAnimateX position={-60} className="w-full md:w-1/2 flex flex-col justify-center z-10">
          ...
          <DivAnimateX position={60} className="w-full md:w-1/2 flex justify-center items-center m-0 p-0 mt-8 md:mt-0">
