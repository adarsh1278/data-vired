...
const TeamDetailSection = ({ teamInfo }) => {
  return (
    <section className="overflow-hidden template_agent section-padding">
      <div className="container">
        <DivAnimateY className="row g-4">
          <div className="col-lg-4">
            <div className="single_agent">
              <div className="single_agent_image">
                <img src={teamInfo.img} className="img-fluid" alt="" />
              </div>
            </div>
          </div>
          <div className="col-lg-8">
            <div className="single_agent">
              <div className="single_agent_content">
                ...
                <ul>
                  <li>
                    <i className="fa fa-envelope-o"></i>contact@gmail.com
                  </li>
                  <li>
                    <i className="fa fa-phone"></i>(+123) 425 857 954 148
                  </li>
                  <li>
                    <i className="fa fa-plane"></i>www.example.com
                  </li>
                  <li>
                    <i className="fa fa-skype"></i>skype.myinfo88
                  </li>
                </ul>
              </div>
                    ...
                    <a href="#" className="top_f_facebook">
                      ...
                      >
                        <rect
                          ...
                          height="40"
                          rx="4"
                          fill="url(#paint0_linear_198_1840)"
                        />
